...
function scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    wp_register_script( 'scripts', get_stylesheet_directory_uri() . '/assets/js/scripts.js', array(), '', true );

    if( is_page_template('templates/template-contact-1.php') || is_page_template('templates/template-contact-2.php') ) {
